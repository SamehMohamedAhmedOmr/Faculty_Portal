    ...
    <div class="container col-12">
        ...
        <div class="userNav col-12">
            @if(!Auth::check())
                ...
                <a style="float: right; padding-right: 15px" href="/login">login <i class="fas fa-sign-in-alt"></i></a>
            @else
                <span><i class="fas fa-user" style="margin-right: 10px;"></i>  <a href="/profile">{{ Auth::user()->name_en }}</a></span>
                <a style="float: right; padding-right: 15px" href="/logout">logout <i class="fas fa-sign-out-alt"></i></a>
            @endif
        </div>
