<div class="headerName" style="background-color:#c3cee36e !important;">{{'Practical Schedule'}} &nbsp; <i class="far fa-calendar-alt" style="color: #2c4167;"></i></div>
<style>
    #overlay
    {
...
@php  $StartDate_save = $practicalTIme; @endphp
{{----------------------------------------All Courses------------------------------------------------------}}
@if($canEdit==1)
                            ...
                            if($T9==0){ echo '<td>'; $T9++; $total++;}
                                ...
                                '<div class="set row col-12">
                                    <div class="col-12" style="padding: 2px;">';$subject=\App\Subject::find($day->subject_id);
                                         ...
                                         {
                                            echo
                                            '<form method="post" action="/Panel/Practical/delete" style="display: inline-block;" >
...
<div class="modal-content TimeTableCreate" style="font-size: 14px;z-index: 999 !important;outline: 5px solid #08344d; top: 8%; left: 21%; margin: 0px; width: 800px !important; display: none; height: 493px !important; overflow-y: auto !important;">
    ...
    <div class="modal-body" style="padding: 2%;">
        <div class="form-group form_style">
            <form id="openCourseForm" method="POST" action="/Panel/Practical/Add" style="padding: 15px;" >
                @csrf
                <div class="alert alert-info" style="padding: 8px;"></div>
                <input type="hidden" id="AddPracticalSchedule" name="course_id" value="">
                ...
                <div class="form-group row removeCOntainer" id="labPlaces">
                    <label class="col-4 col-form-label onLable">Select Lab</label>
                    <select class="form-control col-7 onelab" id="lab[]"  style="z-index: 9999 !important;" name="lab[]">
                        @php
                            foreach($labs as $lab)
                            {
                                echo '<option value="'.$lab->id.'">'.$lab->name.' capacity ( '.$lab->seats.'</p> )</option>';
                                echo '<option style="display:none !important;" class="HallSeat" value="'.$lab->seats.'" ></option>';
                            }
                        @endphp
                    </select>
                </div>

                <div class="col-1" id="Addlab"  onclick="addMidtermLabs()" style="float: right;cursor: pointer; margin-right: -20px;margin-top: -65px;display:none;">
