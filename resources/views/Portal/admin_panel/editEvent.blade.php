...
@section('content')
    ...
    <div class="content">
        <div class="container add-event-view">
            ...
            <h3>Edit Event</h3>
            <hr>
            <form action="{{'/events/'.$event->id}}" class="form-group" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-7" style="margin: auto">
                        <textarea style="resize: none;" rows="5" class="form-control" name="description" placeholder="Enter Event Description">{{ $event->description }}</textarea>
                    </div>
                </div>
